defmodule BotArmyGtd.Repo.Migrations.CreateLogEntries do
  ...
  def change do
    create table(:log_entries, primary_key: false) do
      ...
      add :category, :string, null: false, default: "personal", comment: "work|personal|health|learning|care|admin|social"
      ...
      add :source, :string, null: false, default: "user", comment: "user|task_completed|inbox_processed|tui|liveview"
      add :file_written, :boolean, default: false, comment: "Whether written to daily markdown file"
