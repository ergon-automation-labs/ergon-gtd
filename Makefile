...
# Checkouts may live either as a bots/ sibling (../bot_army_infra) or at the
# repo root with bots/ alongside (../bots/bot_army_infra, e.g. ~/code layout).
BOT_ARMY_COMMON_MK := $(firstword $(wildcard \
  $(abspath $(CURDIR)/../bot_army_infra/make/common.mk) \
  $(abspath $(CURDIR)/../bots/bot_army_infra/make/common.mk)))
ifeq ($(wildcard $(BOT_ARMY_COMMON_MK)),)
$(warning bot_army_infra common.mk not found (../bot_army_infra or ../bots/bot_army_infra) - shared targets unavailable)
else
